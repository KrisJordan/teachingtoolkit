...
# The Teaching Toolkit for Instructors

### Leading Courses

<div class="grid cards three-columns" markdown>

-   :material-rocket-launch:{ .lg .middle } **Semester Kickoff**
...
-   :material-lightbulb-group:{ .lg .middle } **Teaching &amp; Learning**
...
-   :material-checkbox-marked:{ .lg .middle } **Official UNC Supported**
    ...
    - Chat and Agents
        - [UNC's PromptLab](./tools/promptlab.md)
...
-   :material-tools:{ .lg .middle } **Useful Tools Beyond UNC's**
...
-   :material-beaker:{ .lg .middle } **Research and Experimental**
    ...
    On the frontiers of AI Educational Technology.

    - [Lenovo Grant Winners]()
